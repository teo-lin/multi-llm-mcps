  ...
  async listTopics() {
    ...
    return {
      content: [
        {
          type: 'text',
          text: `✴️ ✴️ ✴️ ✴️  MCP.Kafdrop: list_topics ✴️ ✴️ ✴️ ✴️\n\nFound ${topics.length} topics:\n\n${JSON.stringify(summary, null, 2)}`,
        },
      ],
    };
  }
  ...
  async getTopicDetails(args) {
    ...
    return {
      content: [
        {
          type: 'text',
          text: `✴️ ✴️ ✴️ ✴️  MCP.Kafdrop: get_topic_details ✴️ ✴️ ✴️ ✴️\n\nTopic: ${topic_name}\n\n${JSON.stringify(data, null, 2)}`,
        },
      ],
    };
  }
  ...
  async listConsumerGroups() {
    ...
    return {
      content: [
        {
          type: 'text',
          text: `✴️ ✴️ ✴️ ✴️  MCP.Kafdrop: list_consumer_groups ✴️ ✴️ ✴️ ✴️\n\nFound ${groups.length} consumer groups:\n\n${JSON.stringify(groups, null, 2)}`,
        },
      ],
    };
  }
  ...
  async getConsumerGroupDetails(args) {
    ...
    return {
      content: [
        {
          type: 'text',
          text: `✴️ ✴️ ✴️ ✴️  MCP.Kafdrop: get_consumer_group_details ✴️ ✴️ ✴️ ✴️\n\nConsumer Group: ${group_id}\n\n${JSON.stringify(data, null, 2)}`,
        },
      ],
    };
  }
