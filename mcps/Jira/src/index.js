      ...
      case 'get_ticket_details': {
        ...
        return {
          content: [
            {
              type: 'text',
              text: `✴️ ✴️ ✴️ ✴️  MCP.Jira: get_ticket_details ✴️ ✴️ ✴️ ✴️\n\n${JSON.stringify(ticket, null, 2)}`,
            },
          ],
        };
      }
      ...
      case 'search_tickets_jql': {
        ...
        return {
          content: [
            {
              type: 'text',
              text: `✴️ ✴️ ✴️ ✴️  MCP.Jira: search_tickets_jql ✴️ ✴️ ✴️ ✴️\n\n${JSON.stringify(results, null, 2)}`,
            },
          ],
        };
      }
      ...
      case 'get_board_issues': {
        ...
        return {
          content: [
            {
              type: 'text',
              text: `✴️ ✴️ ✴️ ✴️  MCP.Jira: get_board_issues ✴️ ✴️ ✴️ ✴️\n\n${JSON.stringify(issues, null, 2)}`,
            },
          ],
        };
      }
      ...
      case 'get_ptls_board_bugs': {
        ...
        return {
          content: [
            {
              type: 'text',
              text: `✴️ ✴️ ✴️ ✴️  MCP.Jira: get_ptls_board_bugs ✴️ ✴️ ✴️ ✴️\n\n${JSON.stringify(bugs, null, 2)}`,
            },
          ],
        };
      }
      ...
      case 'get_absences_bugs': {
        ...
        return {
          content: [
            {
              type: 'text',
              text: `✴️ ✴️ ✴️ ✴️  MCP.Jira: get_absences_bugs ✴️ ✴️ ✴️ ✴️\n\n${JSON.stringify(bugs, null, 2)}`,
            },
          ],
        };
      }
      ...
      case 'get_team_names': {
        ...
        return {
          content: [
            {
              type: 'text',
              text: `✴️ ✴️ ✴️ ✴️  MCP.Jira: get_team_names ✴️ ✴️ ✴️ ✴️\n\n${JSON.stringify(teams, null, 2)}`,
            },
          ],
        };
      }
